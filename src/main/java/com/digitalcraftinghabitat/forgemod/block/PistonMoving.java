...
public PistonMoving(){
  ...
  @Override  public boolean isOpaqueCube() {
   ...
   @Override public void setBlockBoundsBasedOnState(IBlockAccess blockAccess, int p_149719_2_, int p_149719_3_, int p_149719_4_) {
        TileEntityPiston tileentitypiston = this.func_149963_e(blockAccess, p_149719_2_, p_149719_3_, p_149719_4_);
        if(tileentitypiston != null) {
            ...
            block.setBlockBoundsBasedOnState(blockAccess, p_149719_2_, p_149719_3_, p_149719_4_);
            float f = tileentitypiston.func_145860_a(0.0F);
            if(tileentitypiston.isExtending()) {
                f = 1.0F - f;
            }
